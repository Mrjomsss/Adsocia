...
// --- Function: Counting Animation (Updated to handle "+" format) ---
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Client Stats Counting Animation Observer ---
    ...
    // MODIFIED: Updated phrases for Adsocia agency brand
    const phrases = ["build market presence.", "scale revenue streams.", "craft strategic solutions.", "ensure measurable growth."];
    let phraseIndex = 0;
    let charIndex = 0;
